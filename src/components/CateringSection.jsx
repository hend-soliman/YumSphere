  ...
  return (
    <section className="py-32  bg-[#f9fafd]">
      ...
      <div className="container mt-14 animate__animated animate__bounceIn animate__delay-1s">
        <div className="mx-auto max-w-[800px] rounded-2xl shadow-2xl flex flex-col md:flex-row items-center gap-6 md:gap-8 px-6 md:px-12 py-10 md:py-12">
          <div className="flex justify-center md:justify-end animate__animated animate__heartBeat">
            <img
              src={cateringImg}
              alt="Delicious catering service"
              className="w-[260px] md:w-[300px] lg:w-[340px] object-cover"
            />
          </div>

          <div className="flex flex-col items-center text-center md:text-left gap-4">
            <h3 className="font-bold text-[18px] md:text-[22px] text-[#748194] text-center">
