  ...
  return (
    <>
      <section id="location-timing" className="relative py-44 bg-[#f9fafd]">
        <img  src={green}  className="absolute -left-50 top-1/2  md:top-1/2 w-96 md:w-100 lg:w-125 -translate-y-1/2 z-0 pointer-events-none  animate__animated animate__fadeInLeft"/>
        ...
        <div className="container mx-auto px-4 relative z-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
            ...
            <div className="bg-white h-60 rounded-md shadow-sm p-10 flex flex-col justify-between relative">
              <img src={dish} className="absolute top-2 right-2 w-24 md:w-32 animate__animated animate__fadeInTopRight"/>
              <div>
